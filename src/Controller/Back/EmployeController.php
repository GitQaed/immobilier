...
class EmployeController extends AbstractController
{
    ...
    {
        return $this->render('back/employe/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('back/employe/new.html.twig', [
            'employe' => $employe,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('back/employe/show.html.twig', [
            'employe' => $employe,
        ]);
    }
    ...
    public function edit(Request $request, Employe $employe, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('back/employe/edit.html.twig', [
            'employe' => $employe,
            'form' => $form,
        ]);
    }
